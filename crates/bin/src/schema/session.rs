...
use crate::schema::ids::{AgentID, ProjectID, SessionID, SessionMessageID};
use crate::schema::location::LocationRef;
use crate::schema::llm::ProviderMetadata;
use crate::schema::model::ModelRef;
use crate::schema::prompt::{FileAttachment, Prompt};
use crate::schema::revert::RevertState;
use crate::schema::llm::ToolContent;
...
impl SessionMessageUnknownError {
...
impl Default for SessionMessageUnknownError {
    fn default() -> Self {
        Self::new("")
    }
}
...
pub enum SessionMessage {
    ...
    User {
        ...
        #[serde(skip_serializing_if = "Option::is_none")]
        agents: Option<Vec<crate::schema::prompt::AgentAttachment>>,
    },
