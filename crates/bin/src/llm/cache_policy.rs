...
fn resolve(policy: Option<&CachePolicy>) -> CachePolicyObject {
    match policy {
        None | Some(CachePolicy::Mode(crate::llm::schema::CachePolicyMode::Auto)) => CachePolicyObject {
            tools: Some(true),
            system: Some(true),
            messages: Some(crate::llm::schema::CachePolicyMessages::Strategy(
                crate::llm::schema::CachePolicyMessageStrategy::LatestUserMessage,
            )),
            ttl_seconds: None,
        },
        Some(CachePolicy::Mode(crate::llm::schema::CachePolicyMode::None)) => CachePolicyObject::default(),
...
fn last_index_of_role(messages: &[Message], role: crate::llm::schema::MessageRole) -> isize {
    let mut idx = -1;
...
fn mark_messages(
    messages: &[Message],
    strategy: &crate::llm::schema::CachePolicyMessages,
    hint: &CacheHint,
) -> Option<Vec<Message>> {
    ...
    match strategy {
        crate::llm::schema::CachePolicyMessages::Strategy(
            crate::llm::schema::CachePolicyMessageStrategy::LatestUserMessage,
        ) => mark_message_at(messages, last_index_of_role(messages, crate::llm::schema::MessageRole::User), hint),
        crate::llm::schema::CachePolicyMessages::Strategy(
            crate::llm::schema::CachePolicyMessageStrategy::LatestAssistant,
        ) => mark_message_at(messages, last_index_of_role(messages, crate::llm::schema::MessageRole::Assistant), hint),
        crate::llm::schema::CachePolicyMessages::Tail { tail } => {
