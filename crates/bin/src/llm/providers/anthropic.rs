...
use crate::llm::schema::{ContentPart, LlmError, LlmRequest, LlmResponse, Message, MessageRole, Usage};
...
impl LlmProvider for AnthropicProvider {
    ...
    async fn generate(&self, request: &LlmRequest) -> Result<LlmResponse, LlmError> {
        ...
        let finish_reason = result["stop_reason"].as_str()
            .map(|s| match s {
                "end_turn" => crate::llm::schema::FinishReason::Stop,
                "max_tokens" => crate::llm::schema::FinishReason::Length,
                "tool_use" => crate::llm::schema::FinishReason::ToolCalls,
                _ => crate::llm::schema::FinishReason::Unknown,
            })
            .unwrap_or_default();
